...
* **Key Tasks:** * Mathematical parameter estimation (means and variances conditionned on class).
...
* **Key Insights:** * Construction of the **Gram Matrix** using polynomial kernels.
